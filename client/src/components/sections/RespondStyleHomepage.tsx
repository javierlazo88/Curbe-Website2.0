  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full flex flex-col gap-6 lg:gap-8">
        ...
        {/* Official Partners Strip — full-width, prominent inside hero */}
        <div className="mt-6 sm:mt-8">
              <div
                className="relative rounded-2xl px-5 sm:px-8 py-5 sm:py-6 backdrop-blur-xl border border-white/60 overflow-hidden"
                style={{
                  background: 'linear-gradient(135deg, rgba(255,255,255,0.85) 0%, rgba(255,255,255,0.55) 100%)',
                  boxShadow: '0 10px 40px -12px rgba(37,99,235,0.18), inset 0 1px 0 rgba(255,255,255,0.8)',
                }}
                data-testid="hero-partners-strip"
              >
                <div
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8">
                  ...
                  <div className="flex flex-wrap items-center justify-center md:justify-around gap-x-8 sm:gap-x-12 gap-y-4 flex-1">
                    ...
                    <svg className="h-7 sm:h-8 w-auto" viewBox="0 0 272 92" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Google">
                      <path d="M115.75 47.18c0-12.77-9.99-22.18-22.25-22.18S71.25 34.41 71.25 47.18c0 12.85 9.99 22.18 22.25 22.18s22.25-9.33 22.25-22.18zm-9.74 0c0 7.98-5.79 13.44-12.51 13.44S80.99 55.16 80.99 47.18c0-8.07 5.79-13.44 12.51-13.44s12.51 5.37 12.51 13.44z" fill="#EA4335"/>
                      <path d="M163.75 47.18c0-12.77-9.99-22.18-22.25-22.18s-22.25 9.41-22.25 22.18c0 12.85 9.99 22.18 22.25 22.18s22.25-9.33 22.25-22.18zm-9.74 0c0 7.98-5.79 13.44-12.51 13.44s-12.51-5.46-12.51-13.44c0-8.07 5.79-13.44 12.51-13.44s12.51 5.37 12.51 13.44z" fill="#FBBC05"/>
                    ...
                    {/* TikTok */}
                    <svg className="h-7 sm:h-9 w-auto" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="TikTok">
                      ...
                      <path d="M28.16 5.673V0h-4.675v26.107c0 1.648-.47 3.243-1.348 4.355-.799 1.055-1.92 1.68-3.113 1.68-2.348 0-4.25-1.889-4.25-4.214 0-2.401 1.992-4.335 4.382-4.214v-5.81c-5.457-.33-9.898 4.039-9.898 9.482 0 5.443 4.441 9.812 9.898 9.482 2.39-.144 4.561-1.087 6.198-2.6 2.025-1.872 3.281-4.487 3.281-7.382V13.502a15.059 15.059 0 008.434 2.636v-5.86a8.94 8.94 0 01-8.909-4.605z" fill="#111111"/>
                    </svg>

                    {/* LinkedIn */}
                    <div className="flex items-center gap-1.5">
                      <svg className="h-7 sm:h-9 w-auto" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="LinkedIn">
                        <rect width="32" height="32" rx="4" fill="#0A66C2"/>
                        <path d="M11.5 12.5h-3v10h3v-10zM10 8a1.75 1.75 0 100 3.5A1.75 1.75 0 0010 8zM23.5 22.5v-5.6c0-2.7-1.45-3.95-3.4-3.95-1.57 0-2.27.86-2.66 1.46v-1.41h-3c.04.85 0 10 0 10h3v-5.58c0-.27.02-.54.1-.73.22-.54.71-1.1 1.55-1.1 1.09 0 1.53.83 1.53 2.05v5.36h2.88z" fill="#fff"/>
                      </svg>
                      <span className="text-[15px] sm:text-base font-semibold text-gray-800 tracking-tight">Linked<span className="text-[#0A66C2]">in</span></span>
                    </div>
                  </div>
                </div>
              </div>
