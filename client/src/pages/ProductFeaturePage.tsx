...
const slugToI18nKey: Record<string, string> = {
  "ai-copy": "productPages.aiCopy",
  "ai-images": "productPages.aiImages",
  "ai-videos": "productPages.aiVideos",
  "ai-audio": "productPages.aiAudio",
  "video-editor": "productPages.videoEditor",
  "brand-dna": "productPages.brandDNA",
  "smart-launch": "productPages.smartLaunch",
  "special-categories": "productPages.specialCategories",
  "instant-forms": "productPages.instantForms",
  "neural-optimizer": "productPages.neuralOptimizer",
  "campaign-manager": "productPages.campaignManager",
  "auto-fix": "productPages.autoFix",
  "lead-manager": "productPages.leadManager",
  "conversions-api": "productPages.conversionsAPI",
  "audiences": "productPages.audiences",
  "analytics": "productPages.analytics",
};
...
export default function ProductFeaturePage() {
  ...
  const i18nKey = slugToI18nKey[params.feature || ""];
        ...
        <section className="relative px-5 sm:px-6 py-8 lg:py-16">
          <div className="max-w-4xl mx-auto">
            <div className="glass-card-light rounded-3xl p-8 lg:p-10">
              <h2 className="text-2xl font-bold text-gray-900 text-center mb-8">Beneficios Clave</h2>
