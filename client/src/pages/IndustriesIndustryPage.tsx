...
const slugToI18nKey: Record<string, string> = {
  "agencies": "industryPages.agencies",
  "ecommerce": "industryPages.ecommerce",
  "leadgen": "industryPages.leadgen",
  "mediabuyers": "industryPages.mediabuyers",
};

export default function IndustriesIndustryPage() {
  const params = useParams<{ industry: string }>();
  const [, setLocation] = useLocation();
  const { t } = useTranslation();

  const i18nKey = slugToI18nKey[params.industry || ""];
